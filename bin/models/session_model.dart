...
CovidSession covidSessionFromJson(String str) =>
    CovidSession.fromJson(json.decode(str));
...
class CovidSession {
  ...
  factory CovidSession.fromJson(Map<String, dynamic> json) => CovidSession(
        centers: List<VaccineCenter>.from(
            json["centers"].map((x) => VaccineCenter.fromJson(x))),
      );
...
class Session {
  ...
  factory Session.fromJson(Map<String, dynamic> json) => Session(
        ...
        maxAgeLimit:
            json["max_age_limit"] == null ? null : json["max_age_limit"],
        allowAllAge:
